//::///////////////////////////////////////////////
//:: hench_i0_henlvl (parts from the original NW_I0_HENCHMAN)
...
// and destroying them to prevent them going hostile.
   ...
   // Pausanias: copy items for now
    ...
    SetLocalFloat(oNew, "NewHenchChallenge", GetLocalFloat(MeLevel,"NewHenchChallenge"));
    SetLocalFloat(oNew, "AuldarVersion", GetLocalFloat(MeLevel,"AuldarVersion"));
    SetLocalFloat(oNew, "HenchRange", GetLocalFloat(MeLevel,"HenchRange"));
    ...
    SetLocalInt(oNew, "DualWieldState", GetLocalInt(MeLevel, "DualWieldState"));
    SetLocalInt(oNew, "LightOffHand", GetLocalInt(MeLevel, "LightOffHand"));
    SetLocalInt(OBJECT_SELF, "X2_HENCH_STEALTH_MODE", GetLocalInt(OBJECT_SELF, "X2_HENCH_STEALTH_MODE"));

    ...
    void main ()
{
    ...
    // You can change the number (example) switch (Random(2)) ---->  switch (Random(5)) to reflect the number of chests you desire in your array.
        switch (Random(16))
{
        case 0: sObj = "shr_abandon004";
        break;

        case 1: sObj = "shr_creepy004";
        break;

        case 2: sObj = "shr_cryptic004";
        break;

        case 3: sObj = "shr_divine004";
        break;

        case 4: sObj = "shr_eerie004";
        break;

        case 5: sObj = "shr_gloomy004";
        break;

        case 6: sObj = "shr_glowing004";
        break;

        case 7: sObj = "shr_hidden004";
        break;

        case 8: sObj = "shr_magical004";
        break;

        case 9: sObj = "shr_mendicant004";
        break;

        case 10: sObj = "shr_oily004";
        break;

        case 11: sObj = "shr_secluded004";
        break;

        case 12: sObj = "shr_sparking004";
        break;

        case 13: sObj = "shr_spiritual004";
        break;

        case 14: sObj = "shr_weird004";
        break;
}

    //This line designates the TAG of the Waypoint where you want the chest to spawn.
    location lLoc = GetLocation(GetWaypointByTag ("WP_SHRINE1D"));
    ...
    AssignCommand(oArea, DelayCommand(600.0, MagicalChest(OBJECT_TYPE_PLACEABLE, sObj, lLoc)));

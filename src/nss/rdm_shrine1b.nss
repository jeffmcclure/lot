    ...
    void main ()
{
    ...
    // You can change the number (example) switch (Random(2)) ---->  switch (Random(5)) to reflect the number of chests you desire in your array.
        switch (Random(16))
{
        case 0: sObj = "shr_abandon002";
        break;

        case 1: sObj = "shr_creepy002";
        break;

        case 2: sObj = "shr_cryptic002";
        break;

        case 3: sObj = "shr_divine002";
        break;

        case 4: sObj = "shr_eerie002";
        break;

        case 5: sObj = "shr_gloomy002";
        break;

        case 6: sObj = "shr_glowing002";
        break;

        case 7: sObj = "shr_hidden002";
        break;

        case 8: sObj = "shr_magical002";
        break;

        case 9: sObj = "shr_mendicant002";
        break;

        case 10: sObj = "shr_oily002";
        break;

        case 11: sObj = "shr_secluded002";
        break;

        case 12: sObj = "shr_sparking002";
        break;

        case 13: sObj = "shr_spiritual002";
        break;

        case 14: sObj = "shr_weird002";
        break;
}

    //This line designates the TAG of the Waypoint where you want the chest to spawn.
    location lLoc = GetLocation(GetWaypointByTag ("WP_SHRINE1B"));

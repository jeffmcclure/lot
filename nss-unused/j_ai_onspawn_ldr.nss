...
************************* [Targeting] *****************************************/
    ...
    SetAIInteger(AI_MELEE_LAST_TO_NEW_TARGET_CHANCE, 25);
    //SetAIInteger(AI_RANGED_LAST_TO_NEW_TARGET_CHANCE, 20);
    SetAIInteger(AI_SPELL_LAST_TO_NEW_TARGET_CHANCE, 25);
...
************************* [Combat Other - Leaders] ****************************/
    ...
    SetAIInteger(AI_BOSS_MONSTER_SHOUT_RANGE, 50);
...
************************* [Other - Behaviour/Generic] *************************/
    ...
    SetAIInteger(AI_CORPSE_DESTROY_TIME, 180);

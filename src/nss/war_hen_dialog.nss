...

    {
        ...
        switch (nMatch)
            ...
            //        }
                ...
                case 14://Jarulf attack
                    {

                    if (oNearestSeenEnemy == OBJECT_INVALID)
                        {
                        SpeakString("Attack?  Attack what?");
                        }
                    else
                        {
                        if (GetIsFighting(OBJECT_SELF))
                            {
                            SpeakString("I'm already slaughtering these things, are you blind?");
                            }
                        else
                            {
                            SetAssociateState(NW_ASC_MODE_STAND_GROUND,TRUE);
                ...
                case 16://Jarulf wait there
                    {
                    SpeakString("Oh, so you want me to stay here?  Fine, but make it quick.");
                    ClearAllActions();
                    SetAssociateState(NW_ASC_MODE_STAND_GROUND,TRUE);
                    //ClearAllActions();
                ...
                case 17://wait there
                    ...
                    case 20: //Jarulf Fall Back
                    {

                        if (oNearestSeenEnemy == OBJECT_INVALID)
                            {
                            SpeakString("Retreat?  In our moment of triumph?  Very well.");
                            }
                                ...
                                {
                                SpeakString("Why retreat?  Are the shadows scaring you?");
                                }

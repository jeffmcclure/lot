...
object oanya = GetObjectByTag("anya");

//check to see if tod is in 1st hench slot
object oTarget1=GetHenchman(oPC,1);

if (GetTag(oTarget1)=="toduphill")
    {
    ...
    SetLocalInt(ohench_heartbeat_controlblock, "Tod has been replaced by another henchman", 1);
    //DelayCommand(6.0, DestroyObject(oTarget1));
    }


//check to see if tod is in 2nd hench slot
object oTarget2=GetHenchman(oPC,2);

if (GetTag(oTarget2)=="toduphill")
    {

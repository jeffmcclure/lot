...
void main()
{
    ...
    //--------------------------------------------------------------------------
    ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectDamage(GetMaxHitPoints() -1, DAMAGE_TYPE_MAGICAL, DAMAGE_POWER_ENERGY), OBJECT_SELF);
    ...
    */
    ...
    ActionPlayAnimation(ANIMATION_LOOPING_DEAD_BACK,1.0,4000.0);

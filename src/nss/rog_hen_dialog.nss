...
void main()
{
...

    {
        ...
        switch (nMatch)
                ...
                case 1://Janna Scout Ahead
              //  {
              //      //ExecuteScript("henchscout", OBJECT_SELF);
              ...
              //        }
                ...
                case 12://Janna come here
                    {
                    SpeakString("I am on my way.");
            ...
            //        }
                ...
                case 14://Janna attack
                    {

                    if (oNearestSeenEnemy == OBJECT_INVALID)
                        {
                        SpeakString("I don't see any enemies, can you tell me where they are?");
                        }
                    else
                        {
                        if (GetIsFighting(OBJECT_SELF))
                            {
                            SpeakString("I'm already attacking them, can't you see?");
                            }
                        else
                            {
                            SetAssociateState(NW_ASC_MODE_STAND_GROUND,TRUE);
                ...
                case 16://Janna wait there
                    {
                    SpeakString("I will stay here until you call me, but don't be gone too long.");
                    ClearAllActions();
                    SetAssociateState(NW_ASC_MODE_STAND_GROUND,TRUE);
                    //ClearAllActions();
                ...
                case 17://wait there
                    ...
                    case 20: //Janna Fall Back
                    {

                        if (oNearestSeenEnemy == OBJECT_INVALID)
                            {
                            SpeakString("I will fall back if that is what you want.");
                            }
                                ...
                                {
                                SpeakString("I don't need to retreat.  I'm quite safe here.");
                                }

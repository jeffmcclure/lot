...
//check to see if ileria is in 1st hench slot
object oTarget1=GetHenchman(oPC,1);

if (GetTag(oTarget1)=="ileria")
    {
    ...
    SetLocalInt(ohench_heartbeat_controlblock, "Ileria has been replaced by another henchman", 1);
    //DelayCommand(6.0, DestroyObject(oTarget1));
    }


//check to see if ileria is in 2nd hench slot
object oTarget2=GetHenchman(oPC,2);

if (GetTag(oTarget2)=="ileria")
   {

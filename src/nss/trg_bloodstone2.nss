void main()
{
    ...
    if(GetLocalInt(OBJECT_SELF,"") == FALSE &&
       GetTag(oItem) == "D1_BLOODSTONE2" )
    {
        DestroyObject(oItem);
        object oDoor = GetObjectByTag("DOOR_BLOOD2");
        ...
        object oSpawn;
        location lTarget;
        oTarget = GetWaypointByTag("PORTAL_BLOODSTONE2");
...
//apply to the WP's location instead
        ...
        FloatingTextStringOnCreature("The door to the West has unlocked!", oPC);
    }
}

...
void main()
{
   ...
   //  SetListenPattern(OBJECT_SELF,"T'kron scout ahead",1);
   //  SetListenPattern(OBJECT_SELF,"T'kron Scout ahead",1);
   //  SetListenPattern(OBJECT_SELF,"T'kron scout Ahead",1);
   //  SetListenPattern(OBJECT_SELF,"T'kron Scout Ahead",1);
   //  SetListenPattern(OBJECT_SELF,"t'kron scout ahead",1);
   ...
   SetListenPattern(OBJECT_SELF,"T'kron hide",4);
   SetListenPattern(OBJECT_SELF,"T'kron Hide",4);
   SetListenPattern(OBJECT_SELF,"t'kron hide",4);
   SetListenPattern(OBJECT_SELF,"t'kron Hide",4);
   ...
   SetListenPattern(OBJECT_SELF,"T'kron arm melee",6);
   SetListenPattern(OBJECT_SELF,"T'kron Arm melee",6);
   SetListenPattern(OBJECT_SELF,"T'kron arm Melee",6);
   SetListenPattern(OBJECT_SELF,"T'kron Arm Melee",6);
   SetListenPattern(OBJECT_SELF,"t'kron arm melee",6);
   ...
   SetListenPattern(OBJECT_SELF,"T'kron arm ranged",7);
   SetListenPattern(OBJECT_SELF,"T'kron Arm ranged",7);
   SetListenPattern(OBJECT_SELF,"T'kron arm Ranged",7);
   SetListenPattern(OBJECT_SELF,"T'kron Arm Ranged",7);
   SetListenPattern(OBJECT_SELF,"t'kron arm ranged",7);
   ...
   SetListenPattern(OBJECT_SELF,"T'kron come here",12);
   SetListenPattern(OBJECT_SELF,"T'kron Come here",12);
   SetListenPattern(OBJECT_SELF,"T'kron Come Here",12);
   SetListenPattern(OBJECT_SELF,"t'kron come here",12);
   SetListenPattern(OBJECT_SELF,"t'kron Come here",12);
   ...
   SetListenPattern(OBJECT_SELF,"T'kron attack",14);
   SetListenPattern(OBJECT_SELF,"T'kron Attack",14);
   SetListenPattern(OBJECT_SELF,"t'kron attack",14);
   SetListenPattern(OBJECT_SELF,"t'kron Attack",14);
   ...
   SetListenPattern(OBJECT_SELF,"T'kron wait there",16);
   SetListenPattern(OBJECT_SELF,"T'kron Wait there",16);
   SetListenPattern(OBJECT_SELF,"T'kron Wait There",16);
   SetListenPattern(OBJECT_SELF,"t'kron wait there",16);
   SetListenPattern(OBJECT_SELF,"t'kron Wait there",16);
   ...
   SetListenPattern(OBJECT_SELF,"T'kron fall back",20);
   SetListenPattern(OBJECT_SELF,"t'kron Fall back",20);
   SetListenPattern(OBJECT_SELF,"T'kron Fall Back",20);
   SetListenPattern(OBJECT_SELF,"t'kron fall back",20);
   SetListenPattern(OBJECT_SELF,"t'kron Fall back",20);

    ...
    void main ()
{
    ...
    // You can change the number (example) switch (Random(2)) ---->  switch (Random(5)) to reflect the number of chests you desire in your array.
        switch (Random(16))
{
        case 0: sObj = "shr_abandon";
        break;

        case 1: sObj = "shr_creepy";
        break;

        case 2: sObj = "shr_cryptic";
        break;

        case 3: sObj = "shr_divine";
        break;

        case 4: sObj = "shr_eerie";
        break;

        case 5: sObj = "shr_gloomy";
        break;

        case 6: sObj = "shr_glowing";
        break;

        case 7: sObj = "shr_hidden";
        break;

        case 8: sObj = "shr_magical";
        break;

        case 9: sObj = "shr_mendicant";
        break;

        case 10: sObj = "shr_oily";
        break;

        case 11: sObj = "shr_secluded";
        break;

        case 12: sObj = "shr_sparking";
        break;

        case 13: sObj = "shr_spiritual";
        break;

        case 14: sObj = "shr_town";
        break;

        case 15: sObj = "shr_weird";
        break;
}

    //This line designates the TAG of the Waypoint where you want the chest to spawn.
    location lLoc = GetLocation(GetWaypointByTag ("WP_SHRINE1F"));
    ...
    AssignCommand(oArea, DelayCommand(15.0, MagicalChest(OBJECT_TYPE_PLACEABLE, sObj, lLoc)));

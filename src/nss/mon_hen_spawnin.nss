...
void main()
{
   ...
   //  SetListenPattern(OBJECT_SELF,"Mello scout ahead",1);
   //  SetListenPattern(OBJECT_SELF,"Mello Scout ahead",1);
   //  SetListenPattern(OBJECT_SELF,"Mello scout Ahead",1);
   //  SetListenPattern(OBJECT_SELF,"Mello Scout Ahead",1);
   //  SetListenPattern(OBJECT_SELF,"mello scout ahead",1);
   ...
   SetListenPattern(OBJECT_SELF,"Mello hide",4);
   SetListenPattern(OBJECT_SELF,"Mello Hide",4);
   SetListenPattern(OBJECT_SELF,"mello hide",4);
   SetListenPattern(OBJECT_SELF,"mello Hide",4);
   ...
   SetListenPattern(OBJECT_SELF,"Mello arm melee",6);
   SetListenPattern(OBJECT_SELF,"Mello Arm melee",6);
   SetListenPattern(OBJECT_SELF,"Mello arm Melee",6);
   SetListenPattern(OBJECT_SELF,"Mello Arm Melee",6);
   SetListenPattern(OBJECT_SELF,"mello arm melee",6);
   ...
   SetListenPattern(OBJECT_SELF,"Mello arm ranged",7);
   SetListenPattern(OBJECT_SELF,"Mello Arm ranged",7);
   SetListenPattern(OBJECT_SELF,"Mello arm Ranged",7);
   SetListenPattern(OBJECT_SELF,"Mello Arm Ranged",7);
   SetListenPattern(OBJECT_SELF,"mello arm ranged",7);
   ...
   SetListenPattern(OBJECT_SELF,"Mello come here",12);
   SetListenPattern(OBJECT_SELF,"Mello Come here",12);
   SetListenPattern(OBJECT_SELF,"Mello Come Here",12);
   SetListenPattern(OBJECT_SELF,"mello come here",12);
   SetListenPattern(OBJECT_SELF,"mello Come here",12);
   ...
   SetListenPattern(OBJECT_SELF,"Mello attack",14);
   SetListenPattern(OBJECT_SELF,"Mello Attack",14);
   SetListenPattern(OBJECT_SELF,"mello attack",14);
   SetListenPattern(OBJECT_SELF,"mello Attack",14);
   ...
   SetListenPattern(OBJECT_SELF,"Mello wait there",16);
   SetListenPattern(OBJECT_SELF,"Mello Wait there",16);
   SetListenPattern(OBJECT_SELF,"Mello Wait There",16);
   SetListenPattern(OBJECT_SELF,"mello wait there",16);
   SetListenPattern(OBJECT_SELF,"mello Wait there",16);
   ...
   SetListenPattern(OBJECT_SELF,"Mello fall back",20);
   SetListenPattern(OBJECT_SELF,"mello Fall back",20);
   SetListenPattern(OBJECT_SELF,"Mello Fall Back",20);
   SetListenPattern(OBJECT_SELF,"mello fall back",20);
   SetListenPattern(OBJECT_SELF,"mello Fall back",20);

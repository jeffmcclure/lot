    ...
    void main ()
{
    ...
    // You can change the number (example) switch (Random(2)) ---->  switch (Random(5)) to reflect the number of chests you desire in your array.
        switch (Random(16))
{
        case 0: sObj = "shr_abandon003";
        break;

        case 1: sObj = "shr_creepy003";
        break;

        case 2: sObj = "shr_cryptic003";
        break;

        case 3: sObj = "shr_divine003";
        break;

        case 4: sObj = "shr_eerie003";
        break;

        case 5: sObj = "shr_gloomy003";
        break;

        case 6: sObj = "shr_glowing003";
        break;

        case 7: sObj = "shr_hidden003";
        break;

        case 8: sObj = "shr_magical003";
        break;

        case 9: sObj = "shr_mendicant003";
        break;

        case 10: sObj = "shr_oily003";
        break;

        case 11: sObj = "shr_secluded003";
        break;

        case 12: sObj = "shr_sparking003";
        break;

        case 13: sObj = "shr_spiritual003";
        break;

        case 14: sObj = "shr_weird003";
        break;
}

    //This line designates the TAG of the Waypoint where you want the chest to spawn.
    location lLoc = GetLocation(GetWaypointByTag ("WP_SHRINE1C"));

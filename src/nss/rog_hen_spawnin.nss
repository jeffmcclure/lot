...
void main()
{
   ...
   //  SetListenPattern(OBJECT_SELF,"Janna scout ahead",1);
   //  SetListenPattern(OBJECT_SELF,"Janna Scout ahead",1);
   //  SetListenPattern(OBJECT_SELF,"Janna scout Ahead",1);
   //  SetListenPattern(OBJECT_SELF,"Janna Scout Ahead",1);
   //  SetListenPattern(OBJECT_SELF,"janna scout ahead",1);
   ...
   SetListenPattern(OBJECT_SELF,"Janna hide",4);
   SetListenPattern(OBJECT_SELF,"Janna Hide",4);
   SetListenPattern(OBJECT_SELF,"janna hide",4);
   SetListenPattern(OBJECT_SELF,"janna Hide",4);
   ...
   SetListenPattern(OBJECT_SELF,"Janna arm melee",6);
   SetListenPattern(OBJECT_SELF,"Janna Arm melee",6);
   SetListenPattern(OBJECT_SELF,"Janna arm Melee",6);
   SetListenPattern(OBJECT_SELF,"Janna Arm Melee",6);
   SetListenPattern(OBJECT_SELF,"janna arm melee",6);
   ...
   SetListenPattern(OBJECT_SELF,"Janna arm ranged",7);
   SetListenPattern(OBJECT_SELF,"Janna Arm ranged",7);
   SetListenPattern(OBJECT_SELF,"Janna arm Ranged",7);
   SetListenPattern(OBJECT_SELF,"Janna Arm Ranged",7);
   SetListenPattern(OBJECT_SELF,"janna arm ranged",7);
   ...
   SetListenPattern(OBJECT_SELF,"Janna come here",12);
   SetListenPattern(OBJECT_SELF,"Janna Come here",12);
   SetListenPattern(OBJECT_SELF,"Janna Come Here",12);
   SetListenPattern(OBJECT_SELF,"janna come here",12);
   SetListenPattern(OBJECT_SELF,"janna Come here",12);
   ...
   SetListenPattern(OBJECT_SELF,"Janna attack",14);
   SetListenPattern(OBJECT_SELF,"Janna Attack",14);
   SetListenPattern(OBJECT_SELF,"janna attack",14);
   SetListenPattern(OBJECT_SELF,"janna Attack",14);
   ...
   SetListenPattern(OBJECT_SELF,"Janna wait there",16);
   SetListenPattern(OBJECT_SELF,"Janna Wait there",16);
   SetListenPattern(OBJECT_SELF,"Janna Wait There",16);
   SetListenPattern(OBJECT_SELF,"janna wait there",16);
   SetListenPattern(OBJECT_SELF,"janna Wait there",16);
   ...
   SetListenPattern(OBJECT_SELF,"Janna fall back",20);
   SetListenPattern(OBJECT_SELF,"janna Fall back",20);
   SetListenPattern(OBJECT_SELF,"Janna Fall Back",20);
   SetListenPattern(OBJECT_SELF,"janna fall back",20);
   SetListenPattern(OBJECT_SELF,"janna Fall back",20);
